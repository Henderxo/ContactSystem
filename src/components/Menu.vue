...
<template>
<div ref="menu" class=" flex flex-col border-sm absolute top-20 right-3 shadow-2xl rounded-xl" style=" background-color: white; width: 175px;">
    <div class="menuOption p-2 flex items-center   text-sm">
      <a>Pakeisti slaptažodį</a>
    </div>
